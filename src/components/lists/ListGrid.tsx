...
type SortOption = 'name' | 'createdAt' | 'updatedAt' | 'taskCount' | 'favorites';
    ...
    return (
      <div className={cn('text-center py-12', className)}>
        <div className="text-muted-foreground">
          ...
          <p className="text-sm mb-4">Create your first list to get started organizing your tasks</p>
    ...
    <div className={cn('space-y-6', className)}>
      ...
      {filteredAndSortedLists.length > 0 && (
        <div className="text-center text-sm text-muted-foreground border-t pt-4">
          ...
          {' '}{filteredAndSortedLists.filter(l => l.isFavorite).length} favorite{filteredAndSortedLists.filter(l => l.isFavorite).length !== 1 ? 's' : ''}
        </div>
      )}
    </div>
  );
